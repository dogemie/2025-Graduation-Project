...
# 📌 경로 설정
video_path = "flank_hyundong.MOV"  # 🎥 비디오 파일
...
def save_video2images(video_path, output_folder="images", target_frames=50):
...
def resize_image(img_file):
    ...
    try:
        ...
        resized_image = input_image.resize((width // 4, height // 4), Image.LANCZOS)
